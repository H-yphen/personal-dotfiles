#!/bin/bash
# asl
# by opal hart @wowaname on git.volatile.bz
v="1.0+1 hyphen"
...
ll=(
    ...
    "Missouri" "Montana" "Nebraska" "Nevada" "New Hampshire" "New Jersey" "New Mexco" "New York"
    ...
    "Burundi" "Cambodia" "Cameroon" "Chad" "Chile" "China" "Colombia" "Comoros" "Costa Rica"
    ...
    "U.K." "Uruguay" "Uzbekistan" "Vanuatu" "Vatican City" "Venezuela" "Vietnam" "Yemen"
    "Zambia" "Zimbabwe"
